...
extern "C" void ocl_write_all_comm_buffers_(int* x_max, int* y_max,
...
extern "C" void ocl_read_comm_buffer_(int* xmin, int* xmax, int* ymin, int* ymax,
                                      int* depth, int* xinc, int* yinc,
                                      int* field_name, double* buffer, int* which_edge);

extern "C" void ocl_write_comm_buffer_(int* xmin, int* xmax, int* ymin, int* ymax,
                                       int* depth, int* xinc, int* yinc, 
                                       int* field_name, double* buffer, int* which_edge);
...
void ocl_read_vis_buffers_(int* x_max, int* y_max,
                           double* vertexx, double* vertexy,
                           double* density0, double* energy0,
                           double* pressure, double* viscosity,
                           double* xvel0, double* yvel0)
{
    CloverCL::readVisualisationBuffers(*x_max, *y_max, vertexx, vertexy,
                                       density0, energy0, pressure, viscosity,
                                       xvel0, yvel0);
}

void ocl_read_comm_buffer_(int* xmin, int* xmax, int* ymin, int* ymax,
                           int* depth, int* xinc, int* yinc, int* field_name,
                           double* buffer, int* which_edge)
{
    CloverCL::readCommunicationBuffer(xmin, xmax, ymin, ymax, depth,
                                      xinc, yinc, field_name, buffer, which_edge);
}

void ocl_write_comm_buffer_(int* xmin, int* xmax, int* ymin, int* ymax, int* depth,
                            int* xinc, int* yinc, int* field_name, double* buffer, int* which_edge)
{
    CloverCL::writeCommunicationBuffer(xmin, xmax, ymin, ymax, depth,
                                       xinc, yinc, field_name, buffer, which_edge);
}

void ocl_read_all_comm_buffers_(int* x_max, int* y_max,
                                double* denisty0, double* density1,
                                double* energy0, double* energy1,
                                double* pressure, double* viscosity,
                                double* soundspeed, 
                                ...
                                double* mass_flux_x, double* mass_flux_y)
{
    CloverCL::readAllCommunicationBuffers(x_max, y_max, denisty0, density1, energy0, energy1,
                                          pressure, viscosity, soundspeed,
                                          xvel0, xvel1, yvel0, yvel1,
                                          vol_flux_x, vol_flux_y, mass_flux_x, mass_flux_y);
}

void ocl_write_all_comm_buffers_(int* x_max, int* y_max,
                                 double* denisty0, double* density1,
                                 double* energy0, double* energy1,
                                 double* pressure, double* viscosity,
                                 double* soundspeed, 
                                 ...
                                 double* mass_flux_x, double* mass_flux_y)
{
    CloverCL::writeAllCommunicationBuffers(x_max, y_max, denisty0, density1, energy0, energy1,
                                           pressure, viscosity, soundspeed,
                                           xvel0, xvel1, yvel0, yvel1,
                                           vol_flux_x, vol_flux_y, mass_flux_x, mass_flux_y);
}
