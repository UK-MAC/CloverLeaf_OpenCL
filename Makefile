...
OCL_UP_LOCALWG_SMALLDIM_DEPTHTWO=1 #this value controls the small dimension of the local workgroup size in the update halo kernel when the depth is 2
...
CFLAGS=$(CFLAGS_$(COMPILER)) $(I3E) $(COPTIONS) -c -DCL_USE_DEPRECATED_OPENCL_1_1_APIS -DWG_SIZE_X=$(OCL_LOCAL_WG_SIZE_XDIM) -DWG_SIZE_Y=$(OCL_LOCAL_WG_SIZE_YDIM) -DUH_SMALL_DIM_DEPTHTWO=$(OCL_UP_LOCALWG_SMALLDIM_DEPTHTWO) -DOCL_VERBOSE=1 #-DPROFILE_OCL_KERNELS=1 #-DDUMP_BINARY  
MPI_COMPILER=mpif90
