...
CFLAGS=$(CFLAGS_$(COMPILER)) $(I3E) $(COPTIONS) -c -DCL_USE_DEPRECATED_OPENCL_1_1_APIS -DWG_SIZE_X_REDUCTION=$(OCL_WG_SIZE_X_REDUCTION) $(IDEALGAS_PP) $(ACCELERATE_PP) $(VISCOSITY_PP) $(FLUXCALC_PP) $(RESET_PP) $(REVERT_PP) $(PDV_PP) $(ADVECCELL_PP) $(ADVECMOM_PP) $(UPDATE_HALO_PP) $(COMMS_PP) $(CALDT_FIELDSUMM_PP)  #-DOCL_VERBOSE=1 #-DPROFILE_OCL_KERNELS=1 #-DDUMP_BINARY  
