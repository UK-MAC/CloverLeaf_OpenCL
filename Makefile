...
ifndef OCL_WG_SIZE_X_IDEALGAS
    OCL_WG_SIZE_X_IDEALGAS = 64
    OCL_WG_SIZE_Y_IDEALGAS = 2
endif  
ifndef OCL_WG_SIZE_Y_IDEALGAS
    OCL_WG_SIZE_X_IDEALGAS = 64
    OCL_WG_SIZE_Y_IDEALGAS = 2
endif

ifndef OCL_WG_SIZE_X_VISCOSITY
    OCL_WG_SIZE_X_VISCOSITY = 64
    OCL_WG_SIZE_Y_VISCOSITY = 2
endif
ifndef OCL_WG_SIZE_Y_VISCOSITY
    OCL_WG_SIZE_X_VISCOSITY = 64
    OCL_WG_SIZE_Y_VISCOSITY = 2
endif

ifndef OCL_WG_SIZE_X_ACCELERATE
    OCL_WG_SIZE_X_ACCELERATE = 64
    OCL_WG_SIZE_Y_ACCELERATE = 2
endif
ifndef OCL_WG_SIZE_Y_ACCELERATE
    OCL_WG_SIZE_X_ACCELERATE = 64
    OCL_WG_SIZE_Y_ACCELERATE = 2
endif

ifndef OCL_WG_SIZE_X_FLUXCALC
    OCL_WG_SIZE_X_FLUXCALC = 64
    OCL_WG_SIZE_Y_FLUXCALC = 2
endif
ifndef OCL_WG_SIZE_Y_FLUXCALC
    OCL_WG_SIZE_X_FLUXCALC = 64
    OCL_WG_SIZE_Y_FLUXCALC = 2
endif

ifndef OCL_WG_SIZE_X_RESET
    OCL_WG_SIZE_X_RESET = 64
    OCL_WG_SIZE_Y_RESET = 2
endif
ifndef OCL_WG_SIZE_Y_RESET
    OCL_WG_SIZE_X_RESET = 64
    OCL_WG_SIZE_Y_RESET = 2
endif

ifndef OCL_WG_SIZE_X_REVERT
    OCL_WG_SIZE_X_REVERT = 64
    OCL_WG_SIZE_Y_REVERT = 2
endif
ifndef OCL_WG_SIZE_Y_REVERT
    OCL_WG_SIZE_X_REVERT = 64
    OCL_WG_SIZE_Y_REVERT = 2
endif

ifndef OCL_WG_SIZE_X_PDV
    OCL_WG_SIZE_X_PDV = 64
    OCL_WG_SIZE_Y_PDV = 2
endif
ifndef OCL_WG_SIZE_Y_PDV
    OCL_WG_SIZE_X_PDV = 64
    OCL_WG_SIZE_Y_PDV = 2
endif


ifndef OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S1
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S1 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S1 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S1
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S1 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S1 = 2
endif
ifndef OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S2
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S2 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S2 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S2
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S2 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S2 = 2
endif
ifndef OCL_WG_SIZE_X_ADVCELL_XDIR_SEC2
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC2 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC2 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC2
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC2 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC2 = 2
endif
ifndef OCL_WG_SIZE_X_ADVCELL_XDIR_SEC3
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC3 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC3 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC3
    OCL_WG_SIZE_X_ADVCELL_XDIR_SEC3 = 64
    OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC3 = 2
endif

ifndef OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S1
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S1 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S1 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S1
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S1 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S1 = 2
endif
ifndef OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S2
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S2 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S2 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S2
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S2 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S2 = 2
endif
ifndef OCL_WG_SIZE_X_ADVCELL_YDIR_SEC2
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC2 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC2 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC2
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC2 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC2 = 2
endif
ifndef OCL_WG_SIZE_X_ADVCELL_YDIR_SEC3
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC3 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC3 = 2
endif
ifndef OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC3
    OCL_WG_SIZE_X_ADVCELL_YDIR_SEC3 = 64
    OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC3 = 2
endif
...
ifndef OCL_WG_SIZE_X_ADVMOM_VOL
    OCL_WG_SIZE_X_ADVMOM_VOL = 64
    OCL_WG_SIZE_Y_ADVMOM_VOL = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_VOL
    OCL_WG_SIZE_X_ADVMOM_VOL = 64
    OCL_WG_SIZE_Y_ADVMOM_VOL = 2
endif

ifndef OCL_WG_SIZE_X_ADVMOM_NODE_X
    OCL_WG_SIZE_X_ADVMOM_NODE_X = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_X = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_NODE_X
    OCL_WG_SIZE_X_ADVMOM_NODE_X = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_X = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_NODE_MASS_PRE_X
    OCL_WG_SIZE_X_ADVMOM_NODE_MASS_PRE_X = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_MASS_PRE_X = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_NODE_MASS_PRE_X
    OCL_WG_SIZE_X_ADVMOM_NODE_MASS_PRE_X = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_MASS_PRE_X = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_FLUX_VEC1_X
    OCL_WG_SIZE_X_ADVMOM_FLUX_VEC1_X = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_VEC1_X = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_FLUX_VEC1_X
    OCL_WG_SIZE_X_ADVMOM_FLUX_VEC1_X = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_VEC1_X = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_FLUX_NOTVEC1_X
    OCL_WG_SIZE_X_ADVMOM_FLUX_NOTVEC1_X = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_NOTVEC1_X = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_FLUX_NOTVEC1_X
    OCL_WG_SIZE_X_ADVMOM_FLUX_NOTVEC1_X = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_NOTVEC1_X = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_VEL_X
    OCL_WG_SIZE_X_ADVMOM_VEL_X = 64
    OCL_WG_SIZE_Y_ADVMOM_VEL_X = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_VEL_X
    OCL_WG_SIZE_X_ADVMOM_VEL_X = 64
    OCL_WG_SIZE_Y_ADVMOM_VEL_X = 2
endif

ifndef OCL_WG_SIZE_X_ADVMOM_NODE_Y
    OCL_WG_SIZE_X_ADVMOM_NODE_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_Y = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_NODE_Y
    OCL_WG_SIZE_X_ADVMOM_NODE_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_Y = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_NODE_MASS_PRE_Y
    OCL_WG_SIZE_X_ADVMOM_NODE_MASS_PRE_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_MASS_PRE_Y = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_NODE_MASS_PRE_Y
    OCL_WG_SIZE_X_ADVMOM_NODE_MASS_PRE_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_NODE_MASS_PRE_Y = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_FLUX_VEC1_Y
    OCL_WG_SIZE_X_ADVMOM_FLUX_VEC1_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_VEC1_Y = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_FLUX_VEC1_Y
    OCL_WG_SIZE_X_ADVMOM_FLUX_VEC1_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_VEC1_Y = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_FLUX_NOTVEC1_Y
    OCL_WG_SIZE_X_ADVMOM_FLUX_NOTVEC1_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_NOTVEC1_Y = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_FLUX_NOTVEC1_Y
    OCL_WG_SIZE_X_ADVMOM_FLUX_NOTVEC1_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_FLUX_NOTVEC1_Y = 2
endif
ifndef OCL_WG_SIZE_X_ADVMOM_VEL_Y
    OCL_WG_SIZE_X_ADVMOM_VEL_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_VEL_Y = 2
endif
ifndef OCL_WG_SIZE_Y_ADVMOM_VEL_Y
    OCL_WG_SIZE_X_ADVMOM_VEL_Y = 64
    OCL_WG_SIZE_Y_ADVMOM_VEL_Y = 2
endif
...
ADVECMOM_PP = -DWG_SIZE_X_ADVECMOM_VOL=$(OCL_WG_SIZE_X_ADVMOM_VOL) -DWG_SIZE_Y_ADVECMOM_VOL=$(OCL_WG_SIZE_Y_ADVMOM_VOL) -DWG_SIZE_X_ADVECMOM_NODE_X=$(OCL_WG_SIZE_X_ADVMOM_NODE_X) -DWG_SIZE_Y_ADVECMOM_NODE_X=$(OCL_WG_SIZE_Y_ADVMOM_NODE_X) -DWG_SIZE_X_ADVECMOM_NODE_MASS_PRE_X=$(OCL_WG_SIZE_X_ADVECMOM_NODE_MASS_PRE_X) -DWG_SIZE_Y_ADVECMOM_NODE_MASS_PRE_X=$(OCL_WG_SIZE_Y_ADVECMOM_NODE_MASS_PRE_X) -DWG_SIZE_X_ADVECMOM_FLUX_VEC1_X=$(OCL_WG_SIZE_X_ADVECMOM_FLUX_VEC1_X) -DWG_SIZE_Y_ADVECMOM_FLUX_VEC1_X=$(OCL_WG_SIZE_Y_ADVECMOM_FLUX_VEC1_X) -DWG_SIZE_X_ADVECMOM_FLUX_NOTVEC1_X=$(OCL_WG_SIZE_X_ADVECMOM_FLUX_NOTVEC1_X) -DWG_SIZE_Y_ADVECMOM_FLUX_NOTVEC1_X=$(OCL_WG_SIZE_Y_ADVECMOM_FLUX_NOTVEC1_X) -DWG_SIZE_X_ADVECMOM_VEL_X=$(OCL_WG_SIZE_X_ADVECMOM_VEL_X) -DWG_SIZE_Y_ADVECMOM_VEL_X=$(OCL_WG_SIZE_Y_ADVECMOM_VEL_X) -DWG_SIZE_X_ADVECMOM_NODE_Y=$(OCL_WG_SIZE_X_ADVECMOM_NODE_Y) -DWG_SIZE_Y_ADVECMOM_NODE_Y=$(OCL_WG_SIZE_Y_ADVECMOM_NODE_Y) -DWG_SIZE_X_ADVECMOM_NODE_MASS_PRE_Y=$(OCL_WG_SIZE_X_ADVECMOM_NODE_MASS_PRE_Y) -DWG_SIZE_Y_ADVECMOM_NODE_MASS_PRE_Y=$(OCL_WG_SIZE_Y_ADVECMOM_NODE_MASS_PRE_Y) -DWG_SIZE_X_ADVECMOM_FLUX_VEC1_Y=$(OCL_WG_SIZE_X_ADVECMOM_FLUX_VEC1_Y) -DWG_SIZE_Y_ADVECMOM_FLUX_VEC1_Y=$(OCL_WG_SIZE_Y_ADVECMOM_FLUX_VEC1_Y) -DWG_SIZE_X_ADVECMOM_FLUX_NOTVEC1_Y=$(OCL_WG_SIZE_X_ADVECMOM_FLUX_NOTVEC1_Y) -DWG_SIZE_Y_ADVECMOM_FLUX_NOTVEC1_Y=$(OCL_WG_SIZE_Y_ADVECMOM_FLUX_NOTVEC1_Y) -DWG_SIZE_X_ADVECMOM_VEL_Y=$(OCL_WG_SIZE_X_ADVECMOM_VEL_Y) -DWG_SIZE_Y_ADVECMOM_VEL_Y=$(OCL_WG_SIZE_Y_ADVECMOM_VEL_Y) #-DOCL_VERBOSE=1 #-DPROFILE_OCL_KERNELS=1 #-DDUMP_BINARY  

CFLAGS=$(CFLAGS_$(COMPILER)) $(I3E) $(COPTIONS) -c -DCL_USE_DEPRECATED_OPENCL_1_1_APIS -DWG_SIZE_X=$(OCL_LOCAL_WG_SIZE_XDIM) -DWG_SIZE_Y=$(OCL_LOCAL_WG_SIZE_YDIM) -DUH_SMALL_DIM_DEPTHTWO=$(OCL_UH_LOCALWG_SMALLDIM_DEPTHTWO) -DCOMMS_SMALL_DIM_DEPTHTWO=$(OCL_COMMS_LOCALWG_SMALLDIM_DEPTHTWO) -DWG_SIZE_X_IDEALGAS=$(OCL_WG_SIZE_X_IDEALGAS) -DWG_SIZE_Y_IDEALGAS=$(OCL_WG_SIZE_Y_IDEALGAS) -DWG_SIZE_X_ACCELERATE=$(OCL_WG_SIZE_X_ACCELERATE) -DWG_SIZE_Y_ACCELERATE=$(OCL_WG_SIZE_Y_ACCELERATE) -DWG_SIZE_X_VISCOSITY=$(OCL_WG_SIZE_X_VISCOSITY) -DWG_SIZE_Y_VISCOSITY=$(OCL_WG_SIZE_Y_VISCOSITY) -DWG_SIZE_X_FLUXCALC=$(OCL_WG_SIZE_X_FLUXCALC) -DWG_SIZE_Y_FLUXCALC=$(OCL_WG_SIZE_Y_FLUXCALC) -DWG_SIZE_X_RESET=$(OCL_WG_SIZE_X_RESET) -DWG_SIZE_Y_RESET=$(OCL_WG_SIZE_Y_RESET) -DWG_SIZE_X_REVERT=$(OCL_WG_SIZE_X_REVERT) -DWG_SIZE_Y_REVERT=$(OCL_WG_SIZE_Y_REVERT) -DWG_SIZE_X_PDV=$(OCL_WG_SIZE_X_PDV) -DWG_SIZE_Y_PDV=$(OCL_WG_SIZE_Y_PDV) -DWG_SIZE_X_ADVECCELL_XDIR_SEC1S1=$(OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S1) -DWG_SIZE_Y_ADVECCELL_XDIR_SEC1S1=$(OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S1) -DWG_SIZE_X_ADVECCELL_XDIR_SEC1S2=$(OCL_WG_SIZE_X_ADVCELL_XDIR_SEC1S2) -DWG_SIZE_Y_ADVECCELL_XDIR_SEC1S2=$(OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC1S2) -DWG_SIZE_X_ADVECCELL_XDIR_SEC2=$(OCL_WG_SIZE_X_ADVCELL_XDIR_SEC2) -DWG_SIZE_Y_ADVECCELL_XDIR_SEC2=$(OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC2) -DWG_SIZE_X_ADVECCELL_XDIR_SEC3=$(OCL_WG_SIZE_X_ADVCELL_XDIR_SEC3) -DWG_SIZE_Y_ADVECCELL_XDIR_SEC3=$(OCL_WG_SIZE_Y_ADVCELL_XDIR_SEC3) -DWG_SIZE_X_ADVECCELL_YDIR_SEC1S1=$(OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S1) -DWG_SIZE_Y_ADVECCELL_YDIR_SEC1S1=$(OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S1) -DWG_SIZE_X_ADVECCELL_YDIR_SEC1S2=$(OCL_WG_SIZE_X_ADVCELL_YDIR_SEC1S2) -DWG_SIZE_Y_ADVECCELL_YDIR_SEC1S2=$(OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC1S2) -DWG_SIZE_X_ADVECCELL_YDIR_SEC2=$(OCL_WG_SIZE_X_ADVCELL_YDIR_SEC2) -DWG_SIZE_Y_ADVECCELL_YDIR_SEC2=$(OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC2) -DWG_SIZE_X_ADVECCELL_YDIR_SEC3=$(OCL_WG_SIZE_X_ADVCELL_YDIR_SEC3) -DWG_SIZE_Y_ADVECCELL_YDIR_SEC3=$(OCL_WG_SIZE_Y_ADVCELL_YDIR_SEC3) $(ADVECMOM_PP)
