...
{   
     ...
     */
    CloverCL::enqueueKernel_nooffsets_recordevent_localwg(CloverCL::field_summary_knl, *xmax+2, *ymax+2, 
    ...
    CloverCL::field_summ_time += (t_end.tv_sec * 1.0E6 + t_end.tv_usec) - (t_start.tv_sec * 1.0E6 + t_start.tv_usec);
