 ...
 __global const double* __restrict const vol_flux_z)
{
    ...
    && /*slice >= (z_min + 1) - 2 &&*/ slice <= (z_max + 1) + 2)
    {
        if(mom_sweep == 1)
        {
          post_vol(0,0,0,1,1)= volume(0,0,0,0,0)+vol_flux_y(0 ,1,0,0,1 )-vol_flux_y(0,0,0,0,1)
		+vol_flux_z(0 ,0 ,1,,0,0)-vol_flux_z(0,0,0,0,0);
          pre_vol(0,0,0,1,1)=post_vol(0,0,0,1,1)+vol_flux_x(1,0 ,0,1,0 )-vol_flux_x(0,0,0,1,0);
